      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ padding: 16, gap: 8 }}>
          <Card style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
            ...
            />
            <Text variant="bodyStrong">Online · Lekki</Text>
            <Text
        ...
        >
          ...
          >
            <View>
              <Text variant="heading">Looking for trips</Text>
              <Text variant="caption" tone="text2">
                Demand high around Lekki Phase 1 · 12 trips today
              </Text>
            </View>
            <Button
          ...
          <Button
            testID={TEST_IDS.driver.home.goOffline}
            label="Go offline"
            kind="secondary"
            onPress={() => {}}
          />
