/**
 * Global Setup for Restaurant Portal E2E Tests
 */

import { FullConfig } from "@playwright/test";

async function globalSetup(config: FullConfig): Promise<void> {
  console.log("🍔 Starting Restaurant Portal E2E test setup...");
  ...
  console.log("✅ Restaurant Portal E2E test setup complete!");
}
