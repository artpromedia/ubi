...
const base: PolicyEditorProps = {
  ...
  bounds: [
    {
      label: "ride:go",
      value: "floor ₦1,200 · cost ₦900 · 60%–150%",
      mono: true,
    },
    {
      label: "delivery:moto",
      value: "floor ₦800 · cost ₦600 · 60%–150%",
      mono: true,
    },
  ],
  boundsError: null,
  ...
  previewLine: null,
  audit: [
    { version: "v7", line: "raise moto floor · by ada · approved by chidi" },
  ],
