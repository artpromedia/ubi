...
export function StatusPill({
  ...
  const tone = (): { bg: string; fg: string; dashed?: boolean } => {
    switch (status) {
      case "suggestion":
        return { bg: t.colors.bg2, fg: t.colors.text2, dashed: true };
      case "live":
      case "scheduled":
        return { bg: t.colors.travelTint, fg: t.colors.travelInk };
      ...
      case "paused":
        return { bg: t.colors.warnTint, fg: t.colors.warnInk };
      case "confirmed":
      case "ticketed":
      case "reserved":
      case "assigned":
      ...
      case "earned":
      case "rewarded":
        return { bg: t.colors.okTint, fg: t.colors.ok };
      case "failed":
      case "reversed":
      case "not_reserved":
      case "revoked":
      case "cancelled":
        return { bg: t.colors.errorTint, fg: t.colors.errorInk };
      case "refunded":
      case "not_booked":
        return { bg: t.colors.bg2, fg: t.colors.text2 };
      default:
        return { bg: t.colors.bg2, fg: t.colors.text2 };
    }
  };
