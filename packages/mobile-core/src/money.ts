...
export type MoneyFormat = {
  ...
  minorDigitsShown: number;
  locale: string;
};
const DEFAULT: MoneyFormat = {
  currencySymbol: "₦",
  minorDigitsShown: 0,
  locale: "en-NG",
};
...
export function accessibleMoney(
  m: Money | undefined,
  currencyName = "naira",
): string {
