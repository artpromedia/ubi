...
export const TID = {
  rider: {
    home: { askUbi: "rider.home.askUbi", benefits: "rider.home.benefits" },
    quote: {
  ...
  ask: {
    ...
    composer: { input: "ask.composer.input", send: "ask.composer.send" },
  },
  mandates: {
  ...
  driver: {
    home: { incentiveStrip: "driver.home.incentiveStrip" },
    incentives: {
  ...
  common: {
    ...
    offline: { banner: "common.offline.banner" },
  },
} as const;
