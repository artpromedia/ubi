  ...
  "inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-medium",
  {
    variants: {
      status: {
        ...
        "looking-for-driver": "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400",
        ...
        "pickup-scheduled": "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400",
        ...
        "payment-completed": "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400",
...
const StatusBadge = React.forwardRef<HTMLSpanElement, StatusBadgeProps>(
  ({ className, status = "active", size, pulse, showDot = true, children, ...props }, ref) => {
