...
export const dark = {
  ...
  primary: "#1DB954",
  primaryInk: "#22D66A",
  primaryTint: "rgba(34,214,106,0.15)",
  onPrimary: "#191414",
  link: "#63B3ED",
  ok: "#22D66A",
  okTint: "rgba(34,214,106,0.15)",
  warn: "#FBB034",
  warnTint: "rgba(251,176,52,0.15)",
  warnInk: "#FBB034",
  error: "#F87171",
  errorTint: "rgba(248,113,113,0.15)",
  errorInk: "#F87171",
  info: "#63B3ED",
  infoTint: "rgba(99,179,237,0.15)",
  travel: "#63B3ED",
  travelTint: "rgba(99,179,237,0.15)",
  travelInk: "#63B3ED",
  bites: "#FF7545",
  bitesTint: "rgba(255,117,69,0.15)",
  bitesInk: "#FF7545",
  send: "#10AEBA",
  sendTint: "rgba(16,174,186,0.15)",
  sendInk: "#10AEBA",
  inverse: "#FFFFFF",
  onInverse: "#191414",
  onInverse2: "#666666",
