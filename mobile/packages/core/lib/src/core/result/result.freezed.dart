...
mixin _$Result<T> {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(Fail<T> value) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(Success<T> value)? success,
    TResult? Function(Fail<T> value)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailImpl<T> extends Fail<T> {
  const _$FailImpl(this.failure) : super._();
...
abstract class Fail<T> extends Result<T> {
  const factory Fail(final Failure failure) = _$FailImpl<T>;
