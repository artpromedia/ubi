...
| Delivery custody/returns (C07, G08)        | `services/delivery-service/internal/{custody,identity,handlers/custody.go}`, migration `20260921033947_delivery_custody`; see `docs/marketplace/DELIVERY_CUSTODY.md`                      |
