...
- **verified** — read in source or run. **specified** — designed and contracted here, not yet built. **unverified build** — RN/native files authored without a compiler or device in this environment. Every `rn/` file is _unverified build_ until CI proves otherwise.
