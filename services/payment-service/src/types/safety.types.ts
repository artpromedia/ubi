...
export const COUNTRY_CONFIGS: Record<string, CountryVerificationConfig> = {
  NG: {
    ...
    ambulanceNumber: "199",
    fireNumber: "199",
    ubiSafetyHotline: "+2349000000001",
  ...
  TZ: {
    ...
    supportedDocuments: ["NATIONAL_ID_TZ", "PASSPORT"],
    primaryIdDocument: "NATIONAL_ID_TZ",
    requiredForRider: ["NATIONAL_ID_TZ"],
    requiredForDriver: ["NATIONAL_ID_TZ"],
    backgroundCheckProvider: "tanzania_police",
    verificationProviders: ["nida_tz", "smile_id"],
    emergencyNumber: "112",
    policeNumber: "112",
    ambulanceNumber: "114",
    fireNumber: "114",
    ubiSafetyHotline: "+255700000001",
    dataProtectionLaw: "Cybercrimes Act 2015",
    consentRequirements: ["data_processing"],
  ...
  UG: {
    country: "UG",
    countryName: "Uganda",
    supportedDocuments: ["NATIONAL_ID_UG", "PASSPORT"],
    primaryIdDocument: "NATIONAL_ID_UG",
    requiredForRider: ["NATIONAL_ID_UG"],
    requiredForDriver: ["NATIONAL_ID_UG"],
    backgroundCheckProvider: "uganda_police",
    verificationProviders: ["nira_ug", "smile_id"],
    emergencyNumber: "999",
    policeNumber: "999",
    ambulanceNumber: "911",
    fireNumber: "999",
    ubiSafetyHotline: "+256700000001",
    dataProtectionLaw: "Data Protection Act 2019",
    consentRequirements: ["data_processing"],
  ...
  CI: {
    ...
    supportedDocuments: ["CNI_CI", "PASSPORT"],
    primaryIdDocument: "CNI_CI",
    requiredForRider: ["CNI_CI"],
    requiredForDriver: ["CNI_CI"],
    backgroundCheckProvider: "cote_ivoire_police",
    verificationProviders: ["oni_ci", "smile_id"],
    emergencyNumber: "110",
    policeNumber: "110",
    ambulanceNumber: "185",
    fireNumber: "180",
    ubiSafetyHotline: "+225070000001",
    dataProtectionLaw: "Law No. 2013-450",
    consentRequirements: ["data_processing"],
  ...
  SN: {
    country: "SN",
    countryName: "Senegal",
    supportedDocuments: ["CNI_SN", "PASSPORT"],
    primaryIdDocument: "CNI_SN",
    requiredForRider: ["CNI_SN"],
    requiredForDriver: ["CNI_SN"],
    backgroundCheckProvider: "senegal_police",
    verificationProviders: ["cni_sn", "smile_id"],
    emergencyNumber: "17",
    policeNumber: "17",
    ambulanceNumber: "1515",
    fireNumber: "18",
    ubiSafetyHotline: "+221770000001",
    dataProtectionLaw: "Law No. 2008-12",
    consentRequirements: ["data_processing"],
