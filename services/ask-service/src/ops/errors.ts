 ...
 * arrive as a `ContractError` with the code the contract names.
 */
import {
  ContractError,
 ...
 * exists. The deterministic primary keys here make that the signal that a
 * request is a replay, not a failure (CLAUDE.md #3).
 */
